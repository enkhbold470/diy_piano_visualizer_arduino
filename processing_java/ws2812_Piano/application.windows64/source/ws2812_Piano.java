...
public class ws2812_Piano extends PApplet {
...
public int MAP(int au32_IN, int au32_INmin, int au32_INmax, int au32_OUTmin, int au32_OUTmax)
{
 ...
 */
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "ws2812_Piano" };
    if (passedArgs != null) {
